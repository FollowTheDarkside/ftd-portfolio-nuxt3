...
<div class="">
    <div class="main-text w-5/6 md:w-1/2 2xl:w-1/3 mx-auto">
        ...
        <p class="my-5">
            ...
            he has been exploring new visual expressions using programming and machine learning technology, and relaxing at home.
        </p>
        <p class="mb-10">
            湘南を拠点として活動するアーティストでありBBOY。 
            ダンサーやエンジニアとしてのキャリアを活かしつつ、 
            ツールや環境に囚われない独自の表現を追求している。 
            近年はプログラミングや機械学習の技術を用いた新しい視覚表現の探求や、 
            家でのんびりするといった活動を行なっている。
        </p>
        <p class="mb-10">
